...
test('test', async () => {
  ...
  await page.locator("input[name='file']").setInputFiles('/home/benflop/GitLab/end-to-end-testing/fixtures/pickle_pandas_tabular_loan_testing.sav');
  ...
  await page.getByText('Click to Browse').click();
  await page.locator("input[name='file']").setInputFiles('/home/benflop/GitLab/end-to-end-testing/fixtures/pickle_scikit_multiclasslr_loan.sav');
  await page.getByRole('button', { name: 'Upload selected files >' }).click();
